...
static cl::opt<bool> PAKMSLLC("pakms-llc",
                                cl::desc("Insert instrutions pakms needed/llc commandline."),
                                cl::init(false));
...
void AArch64PassConfig::addPreEmitPass() {
  ...
  if (TM->Options.PAKMSInsertion||PAKMSLLC)
    addPass(createPAKMSInsertionPass());

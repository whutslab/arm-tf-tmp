...
namespace llvm {
  ...
  public:
    TargetOptions()
        : 
	  PAKMSInsertion(false),PrintMachineCode(false), UnsafeFPMath(false), 
          NoInfsFPMath(false),NoNaNsFPMath(false), NoTrappingFPMath(false),
    ...
    /// aarch64 pakms-insertion option
    unsigned PAKMSInsertion : 1;
